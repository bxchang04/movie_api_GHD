//this version doesn't allow for favorites.
//Try https://github.com/joannamaciolek/my-Flix-movie-app/blob/master/client/src/components/profile-view/profile-view.jsx
//or https://github.com/lorepirri/soflix/blob/v3.5/client/src/components/profile-view/profile-view.jsx
...
export function UpdateView(props) {
  ...
  return (
    <div className="update-view justify-content-center">
      ...
      <p className="lead pl-3 mb-4 warning">Please make sure you fill in every input field before pressing the update button.
      If you want to keep some data as is, fill in the original data again.</p>
